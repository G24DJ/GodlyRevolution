...
export const tours = [
    ...
    info:'join the unforgettable Adventure to Faith',
    ...
    info:'join the unforgettable Adventure of the Bible',
    location:'Your Church',
    duration: 7,
    cost: 0,
},
    ...
    info:'join the unforgettable Adventure of Prayer',
    ...
    info:'join the unforgettable Adventure of the Holy Spirit',
    location:'Your Church',
    duration: 15,
    cost: 0,
},
